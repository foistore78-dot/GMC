...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, children, closeText, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    ...
    >
      ...
      <SheetPrimitive.Close className={cn(
        ...
        closeText && "right-6 top-6 h-auto w-auto px-4 py-2 border bg-background hover:bg-accent font-bold text-xs uppercase tracking-widest rounded-md"
      )}>
        {closeText ? (
          <span>{closeText}</span>
        ) : (
